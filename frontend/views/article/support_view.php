...
<div class="main-text">
    <div class="site-block cf">
        <div class="grid12-8 grid12-m-12 youtube-video-left">
            ...
            <div class="description">
                <?=  $model->body ?>
                <a href="/podderjka" class="more"><img src="/images/icon-back-green.png" alt=""> Назад</a>
        ...
        <?= $this->render('_recomended', ['models' => \common\models\Article::getVideoRecommended()]) ?>
    </div>
</div>